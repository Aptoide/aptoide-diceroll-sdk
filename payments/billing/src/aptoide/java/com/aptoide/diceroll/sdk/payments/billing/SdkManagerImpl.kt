 ...
 *
 * It serves as a mirror of the googlePlay flavor's SdkManagerImpl with
 * identical class name, constructor signature, and public API, using
 * the Aptoide Billing SDK internally.
 */
